...
const KEY_MAP = {
  ...
  '期限': 'deadline', '暫定予算': 'provisional_budget', 'リスク評価コメント': 'secondary_eval_comment',
  ...
  'OJT登録': 'ojt_registered', 'OJT実施': 'ojt_implemented', 'OJT最終確認': 'ojt_confirmed_final', 'OJTID': 'ojt_id', 
